...
from .utils import get_active_tokens, logout_from_device
...
class LogoutView(APIView):
    ...
    def post(self, request):
        ...
        serializer.is_valid(raise_exception=True)
        result = serializer.save(request.user, request)
    ...
    def delete(self, request, device_id=None):
        if device_id:
            try:
                ...
                logout_from_device(request.user, str(device.device_id))
                device.delete()
                return Response({"msg": "Device removed"})
            ...
            return Response({"msg": f"Removed {count} other devices"})
...
class SessionsView(APIView):
    ...
    def get(self, request):
        sessions = get_active_tokens(request.user)
